...
const values = [
  {
    icon: Target,
    title: "Results First",
    desc: "We measure success by your ROI, not by lines of code. Every system we build is tied to a measurable business outcome.",
    color: "#6366f1",
  },
  {
    icon: Zap,
    title: "Speed Without Compromise",
    desc: "We move fast — most projects ship in 2–4 weeks — without cutting corners on quality, security, or documentation.",
    color: "#22d3ee",
  },
  {
    icon: Heart,
    title: "We Actually Care",
    desc: "We treat every client's business like our own. Your wins are our wins. We stay invested long after deployment.",
    color: "#a78bfa",
  },
  {
    icon: Globe,
    title: "Remote-First, World-Class",
    desc: "Our team operates fully remotely across time zones, bringing global expertise to every project we take on.",
    color: "#6366f1",
  },
];
...
const team = [
  {
    ...
    bio: "Specialist in agentic AI systems, LLM pipelines, and automation architecture.",
  },
  {
    name: "Sarah M.",
    ...
    bio: "Expert in NLP, RAG systems, and deploying production-grade AI at scale.",
  },
  {
    name: "Omar K.",
    ...
    bio: "Builds the premium Next.js interfaces and APIs that wrap our AI systems.",
  },
];
          ...
          {[
            {
              ...
              label: "Our Vision",
              color: "#6366f1",
              title: "A world where every business runs on AI",
              desc: "We believe AI should not be a luxury reserved for tech giants. Our vision is a future where any business — from a 2-person startup to a 500-person enterprise — can harness the power of intelligent automation to compete and win.",
            },
            {
              icon: Target,
              label: "Our Mission",
              color: "#22d3ee",
              title: "Make AI practical, fast, and profitable",
              desc: "Our mission is to cut through the AI hype and deliver systems that actually work in the real world. We design, build, and deploy AI solutions that save time, reduce costs, and generate revenue — with zero fluff.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <span style={{
                ...
                color: item.color, marginBottom: "10px", display: "block",
              }}>
                {item.label}
              </span>
              <h3 style={{
                ...
                color: "#f1f5f9", marginBottom: "14px", lineHeight: 1.3,
              }}>
                {item.title}
              </h3>
        ...
        <div style={{
          ...
          >
            ...
            <h2 style={{
              ...
              fontWeight: 800, letterSpacing: "-1px",
              color: "#f1f5f9", marginBottom: "20px", lineHeight: 1.15,
            }}>
            ...
            <p style={{
              ...
              There are hundreds of agencies. Here is why our clients keep
              coming back — and why they refer us to their network.
            </p>
          </motion.div>
