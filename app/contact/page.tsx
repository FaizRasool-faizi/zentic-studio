...
const contactInfo = [
  ...
  },
  {
    ...
    sub: "GMT+5 (Pakistan Standard Time)",
    color: "#22d3ee",
  },
  {
    icon: MapPin,
    ...
    sub: "We work with clients globally",
    color: "#a78bfa",
  },
];
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "700px", margin: "0 auto" }}>
          <motion.div
            ...
            style={{
              ...
              marginBottom: "28px", letterSpacing: "0.08em",
          ...
          >
            Book a free 30-minute strategy call. We will map out exactly how
            AI can help your business — no obligation, no hard sell.
          </motion.p>
        </div>
      </section>
        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              lineHeight: 1.7, fontWeight: 300, marginBottom: "36px",
            }}>
            ...
            {status === "success" ? (
              ...
              >
                ...
                <p style={{ fontSize: "13px", color: "#475569", marginTop: "-12px" }}>
                  Free consultation · No obligation · Reply within 24hrs
                </p>
                ...
                <div style={{
                  ...
                  <div>
                    <label style={{
                      fontSize: "11px", fontWeight: 600,
                      textTransform: "uppercase", letterSpacing: "0.08em",
                      color: "#475569", display: "block", marginBottom: "8px",
                    }}>
                      Full Name *
                    </label>
                    <input
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(255,255,255,0.08)",
                        borderRadius: "10px", padding: "11px 14px",
                        fontSize: "14px", color: formData.service ? "#f1f5f9" : "#475569",
                        outline: "none", fontFamily: "DM Sans, sans-serif",
                        cursor: "pointer",
                      }}
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(255,255,255,0.08)",
                        borderRadius: "10px", padding: "11px 14px",
                        fontSize: "14px", color: formData.budget ? "#f1f5f9" : "#475569",
                        outline: "none", fontFamily: "DM Sans, sans-serif",
                        cursor: "pointer",
                      }}
                    >
                ...
                >
                  {status === "loading" ? (
                    ...
                    <>Send Message — It&apos;s Free <ArrowRight size={16} /></>
                  )}
                </button>
